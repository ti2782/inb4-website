...
<ul class="pagination justify-content-center">';
  ...
  echo '<li class="page-item">    
    <a class="page-link" href="https://blackbirds.inb4sauce.net?pages='.$lastpage.'" tabindex="$prevpage">First</a>
  </li>
  <li class="page-item">    
    <a class="page-link" href="https://blackbirds.inb4sauce.net?pages='.$prevPage.'" tabindex="$prevpage">Previous</a>
';
  }
  if($currentpage > 1) { 
...
echo '<div><a href="https://t.me/inb4sauce" class="fa fa-telegram"></a><a href="https://twitter.com/Inb4Sauce" class="fa fa-twitter"></a></div>';
